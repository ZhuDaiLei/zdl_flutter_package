...
class ZDashedDecoration extends Decoration {
  ...
  ///
  /// The [shape] cannot be interpolated; animating between two [ZDashedDecoration]s
  ...
  ///    [Decoration]s, not just [ZDashedDecoration]s.
  ///  * [lerpFrom] and [lerpTo], which are used to implement [Decoration.lerp]
  ///    and which use [ZDashedDecoration.lerp] when interpolating two
  ///    [ZDashedDecoration]s or a [ZDashedDecoration] to or from null.
...
/// An object that paints a [ZDashedDecoration] into a canvas.
