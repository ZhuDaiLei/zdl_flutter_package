...
class ZDateTimeUtil {
  ...
  ///获取年
  static int getYear() => _now.year;

  ///获取月
  static int getMonth() => _now.month;

  ///获取日
  static int getDay() => _now.day;

  ///获取时
  static int getHour() => _now.hour;

  ///获取分
  static int getMinute() => _now.minute;

  ///获取秒
  static int getSecond() => _now.second;

  ///获取微秒
  static int getCurrentMillisecondsSinceEpoch() => _now.millisecondsSinceEpoch;

  ///获取周几
  static int getWeekday() => _now.weekday;
  ...
  static String getAssignDay(int days, {String format = formatDefault}) {
    days = days ?? 0;
    int time;
    String end;
    if (days >= 0) {
